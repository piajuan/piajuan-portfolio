...
const Works = () => {
  return (
    <div className="container mx-auto">
        <h2 className='text-8xl font-primary text-center my-6 dark:text-white'>stuff i've worked on</h2>
        <section>
          <h3 className='font-tertiary uppercase text-center dark:text-white'>Featured Projects</h3>
          <div className='grid md:grid-cols-3 lg:w-4/5 mx-auto my-8 gap-4'>
            {
