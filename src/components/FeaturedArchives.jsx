...
const FeaturedArchives = () => {
  ...
  return (
    <section ref={featArchivesRef} className='overflow-x-hidden'>
        <h1 className='gs-archives__heading my-8 lg:my-24 text-[8vw] leading-none font-primary whitespace-nowrap dark:text-white'>archives <i className='px-4'>archives</i> archives <i className='px-4'>archives</i> archives </h1>
