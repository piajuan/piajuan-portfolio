    ...
    <div className='h-[calc(100vh-56px)] p-4 [&>*]:select-none'>
      <div className='relative h-full overflow-hidden rounded-lg bg-hero'>
        ...
        <div className='absolute w-full h-full p-4 flex-auto flex flex-col justify-end md:justify-center items-center bg-white/[0.2] backdrop-blur-[180px] border-2 border-solid border-white/[0.18] box-shadow-hero'>
          ...
          {/* content */}
          <h1 className='gs-hero__content text-7xl text-left md:text-[7vw] lg:max-w-[70vw] mx-auto font-primary md:text-center leading-none'>
            I’m Pia —frontend developer & designer
          </h1>
          ...
          <p className='gs-hero__content  max-w-[400px] mt-5 mx-auto mb-14 md:mb-0 text-left md:text-center'>
            with over six years of experience and a passion for delivering
            user-centric interface designs.
          </p>
