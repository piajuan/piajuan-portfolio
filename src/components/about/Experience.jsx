           ...
           <div className="container mx-auto mt-16 lg:mb-[24vh] p-4">
            <div className="flex flex-col gap-6 md:gap-4 lg:flex-row justify-between">
                <div className='w-full lg:w-3/5'>
                    ...
                    <a href="/Sophia_Juan_CV_2024.pdf" target="_blank" className='lg:mt-8 inline-flex items-center dark:text-white hyperlink hyperlink--underline'>see full resume <LucideArrowRight size={16} className='ml-2'/> </a>
                </div>
