import { geh, btsThumb, shkThumb, lusogThumb, featuredImages } from '../assets';
...
export const experience = [
  ...
  },
  {
    ...
    company: 'Oct 2020 - Mar 2024 | HTech Corporation',
...
export const techStack = [
  ...
  'ReactJS, JQuery, TailwindCSS, SASS, Bootstrap, Vue, React Native,', // frameworks
...
export const featuredProjects = [
  {
    ...
    about:
      'A classic todo app with a few added features as part of the frontendmentor challenge. The user can:',
    features: [
  ...
  },
  {
    ...
    about:
      'EasyHub is an interactive one-stop shop for Globe customers. Within Shop and Care Zone, users can:',
    features: [
    ...
    externalLink: [
      'https://www.globe.com.ph/about-us/newsroom/consumer/globe-easyhub-best-in-class-retail-innovation.html',
    ],
  ...
  },
  {
    ...
    about:
      'Lusog-Isip is the first mobile app for mental health and self-care culturally-adapted for the Philippines. It uses evidence-based screening tools and interventions to help you on your journey towards better overall well-being and healthier coping strategies.',
    features: [],
  ...
  },
  {
    ...
    about:
      "As part of the BTS’s 'Live Your Passion with Purpose' campaign, SMART launched a mobile-first microsite where SMART subscribers can gain access to exclusive BTS content and be able to use their devices a digital lightstick. The site can only be accessed by SMART data via mobile devices, and consists of: ",
    features: [
      'Coming Soon',
      'Countdown that started a few days before the TVC Launch',
      'Digital Mobile Lightstick Video',
      'Exclusive videos such as Interviews and Behind the Scenes for PH fans',
      'Hi-Res Photo Gallery (Images above were blurred for demo purposes only',
      'Photocards',
      'Error page for non-SMART subscribers',
    ],
    techText: [
      'HTML',
      'SASS',
    ...
    externalLink: [
      'http://www.anagonzales.com/2021/04/smart-bts-exclusive-website-for-smart.html',
      'https://www.spot.ph/entertainment/movies-music-tv/85944/smart-x-bts-live-your-passion-with-purpose-launch-a588-20210422-lfrm',
      'https://www.bandwagon.asia/articles/bts-smart-commercial-filipino-army-fans-watch-passion-purpose-dynamite-life-goes-onhybe-corporation-big-hit-music-philippines-2021',
    ],
  ...
  },
  {
    ...
    about:
      "I Spy At The Shack is a web app that allows Shake Shack customers to find and collect items using clues provided weekly on the Shake Shack Facebook Page. Users simply need to snap a photo of the required item at the Shake Shack North Edsa branch mural, and there's no need to install anything.",
    features: [],
